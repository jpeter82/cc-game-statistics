...
def export_count_games(source_data, report_file):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.count_games(source_data)):
        result = True
    else:
        result = False
    return result
...
def export_decide(source_data, report_file, year):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.decide(source_data, year)):
        result = True
    else:
        result = False
    return result
...
def export_get_latest(source_data, report_file):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.get_latest(source_data)):
        result = True
    else:
        result = False
    return result
...
def export_count_by_genre(source_data, report_file, genre):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.count_by_genre(source_data, genre)):
        result = True
    else:
        result = False
    return result
...
def export_get_line_number_by_title(source_data, report_file, title):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.get_line_number_by_title(source_data, title)):
        result = True
    else:
        result = False
    return result
...
def export_when_was_top_sold_fps(source_data, report_file):
    ...
    Append actual report to report file. Check out reports.py for content of actual report.
        ...
        @return bool True if successful, otherwise False
    '''
    if append_to_file(source_data, report_file, reports.when_was_top_sold_fps(source_data)):
        result = True
    else:
        result = False
    return result
